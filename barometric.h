//NOTE: This library was created by Santiago Gonzalez
//      All rights for this source code go to him
//      This library will be used for the aerodynamics class

#ifndef CONSTANTS_H
#define CONSTANTS_H

#include <math.h>
#define PASCAL_TO_PSI(x) (x * 0.000145038)
